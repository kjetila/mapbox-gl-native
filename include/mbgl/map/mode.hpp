...
inline MapDebugOptions operator|(MapDebugOptions lhs, MapDebugOptions rhs) {
...
inline bool operator&(MapDebugOptions lhs, MapDebugOptions rhs) {
...
inline MapDebugOptions operator~(MapDebugOptions value) {
